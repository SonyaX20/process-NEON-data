...
def plot_patch_tiles(patch_dir, SITE_CODE, PLOT_DIR, start_patch_id=20, end_patch_id=29, figsize=(10, 10)):
...
def plot_patch_height_genus(
    ...
    """
    file_path = os.path.join(patch_dir, "patch_00025.tif")
...
def calc_biomass(row, wood_density, default_density):
...
def __main__():
    ...
    df_biomass['biomass'] = df_biomass.apply(calc_biomass, wood_density=wood_density, default_density=default_density, axis=1)
